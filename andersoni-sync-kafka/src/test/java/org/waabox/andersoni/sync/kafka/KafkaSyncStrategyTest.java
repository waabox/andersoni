...
class KafkaSyncStrategyTest {
  ...
  void whenPublishing_givenRefreshEvent_shouldSerializeCorrectly() {
    ...
    final String json = KafkaSyncStrategy.serialize(event);
  ...
  void whenDeserializing_givenValidJson_shouldParseRefreshEvent() {
    ...
    final RefreshEvent event = KafkaSyncStrategy.deserialize(json);
  ...
  void whenSerializingAndDeserializing_givenRoundTrip_shouldProduceEqualEvent() {
    ...
    final String json = KafkaSyncStrategy.serialize(original);
    final RefreshEvent restored = KafkaSyncStrategy.deserialize(json);
